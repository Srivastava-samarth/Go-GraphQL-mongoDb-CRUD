...
// DeleteJobLisitng is the resolver for the deleteJobLisitng field.
func (r *mutationResolver) DeleteJobLisitng(ctx context.Context, id string) (*model.DeleteJobResponse, error) {
	return db.DeleteJobLisitng(id),nil
}
